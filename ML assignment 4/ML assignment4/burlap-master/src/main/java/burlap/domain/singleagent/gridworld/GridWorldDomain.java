...
public class GridWorldDomain implements DomainGenerator {
	...
	/**
	 * Will set the domain to use action transitions by probabilistic, agent will move orthogonal direction when with (1-probSucceed)/2
	 */

	public void setProbSucceedOrthogonal(double probSucceed){
		int na = 4;
